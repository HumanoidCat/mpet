...
import { scoreColor, scoreTier, TIER_COLOR, TIER_LABEL, TIER_ENCOURAGEMENT, type ScoreTier } from './pronunciationColor';
  ...
  return (
    <div className="flex flex-col items-center gap-2">
      ...
      <p className="text-xs text-slate-500 text-center max-w-[200px] leading-relaxed">
        {TIER_ENCOURAGEMENT[scoreTier(score)]}
      </p>
    </div>
  );
}
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-2xl p-4 sm:p-5 shadow-lg">
      ...
      <div className="flex items-center gap-3 mb-3">
        <p className="text-xs text-slate-500 flex-shrink-0">Puntaje</p>
    ...
    return (
      <div className="flex-1 overflow-y-auto p-4 sm:p-6 bg-slate-50">
        <div className="max-w-4xl mx-auto flex flex-col gap-4 sm:gap-5">
          <div>
            <h2 className="font-[var(--font-display)] font-bold text-base sm:text-lg text-slate-900">Tu pronunciación</h2>
      ...
      <div className="max-w-4xl mx-auto flex flex-col gap-4 sm:gap-5">
        ...
        <div className="flex flex-col md:grid md:grid-cols-3 gap-4">
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 flex flex-col items-center gap-4 md:col-span-1">
            <h3 className="font-[var(--font-display)] font-bold text-sm text-slate-700">Puntaje general</h3>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-4 sm:p-5 md:col-span-2">
            <div className="flex items-center justify-between mb-3 gap-2 flex-wrap">
              <h3 className="font-[var(--font-display)] font-bold text-sm text-slate-700">Frase analizada</h3>
              {onPlay && (
                <button
                ...
                >
                  <Volume2 className="w-3 h-3" />Escuchar referencia
                </button>
              )}
            </div>
